...
import about1 from '../images/About/Background.png';
import chef1 from '../images/About/chef1.jpg';
import chef2 from '../images/About/chef2.jpg';
import chef3 from '../images/About/chef3.jpg';
import chef4 from '../images/About/chef4.jpg';
import gallery1 from '../images/About/gallery1.webp';
...
import background_introduce from '../images/About/background_introduce.jpg';
    ...
    <div className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <FeatureItem icon={<FaUtensils size={24} />} title="Quality Food" />
          <FeatureItem icon={<FaLeaf size={24} />} title="Organic Ingredients" />
          <FeatureItem icon={<FaWineGlassAlt size={24} />} title="Fine Dining" />
          <FeatureItem icon={<FaCoffee size={24} />} title="Premium Service" />
        </div>
      </div>
    </div>
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="bg-gray-300 h-80 rounded-lg flex items-center justify-center">
            <img src={about1} alt="Restaurant Info" />
          </div>

          <div>
            <h2 className="text-3xl font-bold mb-4">Our Story</h2>
            <p className="text-gray-600 mb-6">
              Founded in 2010, RESTO has been serving delicious meals made with the freshest ingredients. Our chefs are passionate about creating memorable dining experiences for our guests.
            </p>
            <p className="text-gray-600 mb-6">
              We believe in using only the highest quality ingredients, sourced locally whenever possible, to create dishes that delight our customers and keep them coming back for more.
            </p>
    ...
    <div className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <ChefCard imagePlaceholder={chef1} name="John Doe" role="Executive Chef" />
          <ChefCard imagePlaceholder={chef2} name="Jane Smith" role="Pastry Chef" />
          <ChefCard imagePlaceholder={chef3} name="Michael Brown" role="Sous Chef" />
          <ChefCard imagePlaceholder={chef4} name="Sarah Johnson" role="Head Chef" />
        </div>
      </div>
    </div>
