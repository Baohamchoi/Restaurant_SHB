...
import { FaEnvelope, FaLock, FaGoogle, FaFacebookF, FaUser, FaExclamationCircle } from 'react-icons/fa'
...
const Login = () => {
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      password: '',
      rememberMe: isLogin && parsedData.rememberMe ? parsedData.rememberMe : false
    })
    setErrors({})
          ...
          <div className="relative">
            <div className="bg-white p-8 rounded-t-3xl">
              ...
              <div className="mt-8 text-center text-gray-600">
                {isLogin ? (
                  <p>Don't have an account? <button type="button" onClick={() => setIsLogin(false)} className="text-primary hover:underline">Register</button></p>
                ) : (
                  <p>Already have an account? <button type="button" onClick={() => setIsLogin(true)} className="text-primary hover:underline">Login</button></p>
                )}
              </div>
            </div>
          </div>
